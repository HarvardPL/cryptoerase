...
%state STRING, CHARACTER, TRADITIONAL_COMMENT, END_OF_LINE_COMMENT, ACCRUE_ANNOTATION, ACCRUE_COMMENT_ANNOTATION, ACCRUE_COMMENT_ANNOTATION_CONTINUATION, ACCRUE_COMMENT_ANNOTATION_STRING
...
<ACCRUE_COMMENT_ANNOTATION_CONTINUATION> {
...
<ACCRUE_COMMENT_ANNOTATION_STRING> {
    /* End of string */
    \"                           { yybegin(TRADITIONAL_COMMENT);
                                   return string_lit(); }
